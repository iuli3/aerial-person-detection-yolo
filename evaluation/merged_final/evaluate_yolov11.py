...
MODELS = {
    # merged_final 640px
    'YOLOv11m_merged_final': 'experiments/yolo11m/runs/yolo11m_merged_final_640_200ep/weights/best.pt',
    'YOLOv26m_merged_final': 'experiments/yolo26m/runs/yolo26m_merged_final_640px/weights/best.pt',
}

#    Datasets to evaluate                                                        
DATASETS = {
    'VisDrone_DET':   'data/test_subsets/visdrone/data.yaml',
    'HDTopView':      'data/test_subsets/hdtopview/data.yaml',
    'SUAS_Mannequin': 'data/test_subsets/suas/data.yaml',
}
    ...
    for dataset_name, yaml_path in DATASETS.items():
        ...
        try:
            metrics = model.val(
                ...
                plots=True,
                save_json=False,
                project=f'experiments/eval_results_testset_640px/{model_name}',
                name=dataset_name,
                exist_ok=True,
            )
...
#    Save JSON                                                               
out_path = 'experiments/eval_results_640px/results_summary.json'
...
print(f"{'='*95}")
print(f"\nPlots and results in: experiments/eval_results_640px/")

"""
Converts VisDrone VID validation annotations to YOLO format.
All frames are assigned to validation; no additional split is created.
"""
...
BASE      = Path('data/VisDrone2019-VID-val')
SEQS_DIR  = BASE / 'sequences'
ANNS_DIR  = BASE / 'annotations'
OUT       = Path('data/VisDrone_VID_val_YOLO')
...
for ann_file in sorted(ANNS_DIR.glob('*.txt')):
    ...
    for img_file in img_files:
        ...
        out_name = f"vid_val_{seq_name}_{img_file.stem}"
